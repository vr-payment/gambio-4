...
class VRPaymentCheckoutConfirmationThemeContentView extends VRPaymentCheckoutConfirmationThemeContentView_parent
{
	public function prepare_data()
	{
		...
		$configurationStorage = MainFactory::create('VRPaymentStorage');
