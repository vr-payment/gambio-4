...
class VRPaymentRefundEntity
{
	 ...
	 * @return $this
	 */
	public function setId(int $id): VRPaymentRefundEntity
	{
		$this->id = $id;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setRefundId(int $refundId): VRPaymentRefundEntity
	{
	 ...
	 * @return $this
	 */
	public function setOrderId(int $orderId): VRPaymentRefundEntity
	{
	 ...
	 * @return $this
	 */
	public function setAmount(float $amount): VRPaymentRefundEntity
	{
		$this->amount = $amount;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setCreatedAt(string $createdAt): VRPaymentRefundEntity
	{
