...
class VRPaymentPaymentController extends HttpViewController
{
	/**
	 * @throws Exception
	 */
	public function actionPaymentPage()
	{
		...
		$content = $this->_render(
		  'GXModules/VRPayment/VRPaymentPayment/Shop/Themes/All/checkout_payment_vrpayment.html',
		  [
			'appJsUrl' => 'GXModules/VRPayment/VRPaymentPayment/Shop/Templates/All/Javascript/extenders/vrpayment-app.js',
