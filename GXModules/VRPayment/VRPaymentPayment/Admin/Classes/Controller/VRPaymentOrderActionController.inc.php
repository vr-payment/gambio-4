<?php declare(strict_types=1);
	...
	class VRPaymentOrderActionController extends AdminHttpViewController
	{
		...
		public function actionRefund()
		{
			...
			$alreadyRefundedAmount = VRPaymentRefundModel::getTotalRefundsAmount(
				VRPaymentRefundModel::getRefunds($orderId)
			);
		...
		protected function getUnauthorizedResponse(): ?HttpControllerResponse
		{
			...
			if ($this->isAuthenticatedAdmin() && VRPaymentPageToken::isValid($pageToken)) {
				return null;
			}
