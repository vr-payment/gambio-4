...
class VRPayment_AdminApplicationTopPrimalExtender extends VRPayment_AdminApplicationTopPrimalExtender_parent
{
	protected const ORDER_ACTION_CONTROLLER = 'VRPaymentOrderAction';
