...
namespace GXModules\VRPaymentPayment\Library\Core\Api\WebHooks\Service;

use GXModules\VRPaymentPayment\Library\Core\{Service\PaymentService, Settings\Struct\Settings};
...
class WebHooksService
{
	...
	protected function getWebHookCallBackUrl(): string
	{
		if (\function_exists('xtc_catalog_href_link')) {
			return \xtc_catalog_href_link("shop.php", 'do=VRPaymentWebhook/Index');
		}
		...
		if (\defined('HTTP_SERVER')
			...
			return \get_href_link(HTTP_SERVER, HTTPS_CATALOG_SERVER, DIR_WS_CATALOG,
				ENABLE_SSL_CATALOG === 'true' || ENABLE_SSL_CATALOG === true, "shop.php", 'do=VRPaymentWebhook/Index');
		}
		...
		return $url . '/shop.php?do=VRPaymentWebhook/Index';
	}
